<ul id="bp-docs-all-docs">
	...
	<?php if ( is_user_logged_in() ) : ?>
		<?php if ( function_exists( 'bp_is_group' ) && bp_is_group() ) : ?>
			<li<?php if ( bp_is_current_action( BP_DOCS_SLUG ) ) : ?> class="current"<?php endif ?>><a href="<?php esc_url( bp_get_group_url( groups_get_current_group() ) ); ?><?php bp_docs_slug() ?>"><?php echo esc_html( sprintf( __( "%s's Docs", 'buddypress-docs' ), bp_get_current_group_name() ) ); ?></a></li>
		<?php else : ?>
