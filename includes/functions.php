 ...
 * @return nothing (Boolean values that update_post_meta returns are hard to interpret)
 */
function bp_docs_save_doc_access_settings( $doc_id ) {
	...
	// isset( $_POST['settings'] ) is false; the access settings section isn't included on the edit form
	} else {
		// Do nothing.
