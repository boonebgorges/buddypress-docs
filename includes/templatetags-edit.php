...
/**
 * Disables the wplink plugin from the bp_docs editor
 *
 ...
 */
function bp_docs_remove_tinymce_wplink_plugin( $initArray ) {
	if ( bp_docs_is_bp_docs_page() ) {
...
add_filter( 'tiny_mce_before_init', 'bp_docs_remove_tinymce_wplink_plugin' );
